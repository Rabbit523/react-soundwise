...
class _YoutubeDemo extends Component {
  constructor(props) {
    super(props);
  }
          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center center-col">
                ...
                >
                  CONVERT YOUR YOUTUBE CHANNEL INTO PODCAST TO REACH MORE AUDIENCE
                </h2>
                <div
                ...
                >
                  <p>
                    Automatically convert your YouTube channel into an audio podcast and distribute
                    it to iTunes, Spotify, and Google Podcasts. So that more people will find you.
                  </p>
                  <p>
                    Soundwise’s YouTube integration service is the easiest way to create a podcast
                    from the content of your YouTube channel—fast. With just a few clicks, your
                    content will show up on the hottest podcast platforms including iTunes, Spotify,
                    and Google Podcasts. With the same amount of work, you can now triple your
                    audience reach.
                  </p>
                </div>
              </div>
              <div className="col-lg-10 col-md-10 col-sm-12 col-xs-12 display-table center-col">
                <div className="display-table-cell-vertical-middle">
                  <div className="video-overlay">
                    <iframe
                      src="https://player.vimeo.com/video/306600900?title=0&amp;amp;byline=0&amp;amp;portrait=0"
                      width="600"
                      frameborder="0"
                      allowFullScreen=""
                    />
            ...
            <div className="row">
              <div className="col-md-12 col-sm-12 col-xs-12 text-center">
                <h2
                  ...
                  style={{ marginTop: 0 }}
                >
                  Hassle-free YouTube channel conversion, podcast hosting, and automatic update.
                </h2>
                <div
                  className="text-extra-large width-60 margin-lr-auto md-width-70 sm-width-100 tz-text"
                  data-selector=".tz-text"
                >
                  Plans start at $15 / month. 30 day money back guarantee.&nbsp;
                </div>
              </div>
              <div
...
export const YoutubeDemo = connect(
  mapStateToProps,
  null
)(_YoutubeDemo);
